...
// Run with: node migrate-add-application-questions-reach-70-final.js
...
const reach70FinalQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Secular governance always overrides religious freedom', isCorrect: false, explanation: 'Incorrect. While secularism is a basic structure, religious freedom is a fundamental right. The Constitution balances both through reasonable restrictions and equal treatment principles.' },
...
async function addReach70FinalQuestions() {
  try {
    ...
    for (const quiz of quizzes) {
      ...
      const questionTemplate = reach70FinalQuestions[questionsAdded % reach70FinalQuestions.length];
