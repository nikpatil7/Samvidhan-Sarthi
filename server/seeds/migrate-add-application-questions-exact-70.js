...
// Run with: node migrate-add-application-questions-exact-70.js
...
const exact70Questions = [
  {
    question: 'How does the Constitution protect judicial independence from executive and legislative interference?',
    options: [
      { text: 'Judicial independence depends entirely on the executive branch', isCorrect: false, explanation: 'Incorrect. The Constitution protects judicial independence through structural mechanisms like security of tenure, impeachment procedures, and administrative autonomy that reduce executive and legislative interference.' },
      { text: 'Through security of tenure, impeachment procedures, and administrative autonomy', isCorrect: true, explanation: 'Correct! The Constitution protects judicial independence through security of tenure (removal only by impeachment), difficult impeachment process, and administrative autonomy in appointments and judicial conduct.' },
      { text: 'Only through the power of contempt of court', isCorrect: false, explanation: 'Incorrect. While contempt powers are important, the Constitution provides multiple structural protections including tenure security and impeachment procedures to ensure judicial independence.' },
      { text: 'The Constitution does not specifically address judicial independence', isCorrect: false, explanation: 'Incorrect. The Constitution has several specific provisions protecting judicial independence including Articles 124-147 on Supreme Court and High Court appointments, tenure, and removal procedures.' }
    ],
    questionType: 'application'
  },
  {
    question: 'What constitutional principles guide the relationship between fundamental rights and directive principles of state policy?',
    options: [
      { text: 'Directive principles always override fundamental rights', isCorrect: false, explanation: 'Incorrect. While directive principles are important for governance, fundamental rights are enforceable by courts and generally take precedence in case of conflict.' },
      { text: 'Fundamental rights always override directive principles', isCorrect: false, explanation: 'Incorrect. While fundamental rights are enforceable, courts have recognized that directive principles should guide interpretation and legislation should harmonize both where possible.' },
...
async function addExact70Questions() {
  try {
    ...
    for (const quiz of quizzes) {
      ...
      const questionTemplate = exact70Questions[questionsAdded % exact70Questions.length];
