        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <StatCard 
              ...
              value={formatPercent(dashboardData.stats.overallProgress)} 
              icon={
            ...
            <StatCard 
              title="Topic Mastery" 
              value={formatPercent(dashboardData.stats.averageTopicMastery)} 
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <StatCard 
              ...
              value={formatPercent(dashboardData.stats.averageQuizScore)} 
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <StatCard 
              ...
              value={formatPercent(dashboardData.stats.averageScenarioPerformance)} 
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <StatCard 
              ...
              value={formatPercent(dashboardData.stats.averageGameScore)} 
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {analyticsData && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard 
                  title="Scenario Performance" 
                  value={formatPercent(analyticsData.scenarioPerformance.averageScore)} 
                  icon={
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  ...
                  <div className="bg-dark-200 p-4 rounded-lg">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-primary-500">{formatPercent(analyticsData.topicMasteryAnalysis.averageMastery)}</p>
                      </div>
                ...
                {dashboardData.progress.slice(0, 6).map((item) => (
                  <div key={item.topicId} className="bg-dark-200 p-4 rounded-lg">
                    ...
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm text-gray-300">{formatPercent(item.completionPercentage)}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-400">Mastery</span>
                      <span className="text-lg font-semibold text-primary-500">
                        {formatPercent(item.topicMastery)}
                      </span>
                    </div>
                    <div className="w-full bg-dark-300 rounded-full h-2 mt-2 mb-3">
                      <div 
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs text-gray-400">
                      <span>Quiz: {formatPercent(item.quizScore)}</span>
                      <span>Scenario: {formatPercent(item.scenarioPerformanceScore)}</span>
                    </div>
                  </div>
                ))}
              </div>
